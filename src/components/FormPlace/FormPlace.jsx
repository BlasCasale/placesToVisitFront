...
import { clear_error, create_place } from "../../redux/actions";
...
const FormPlace = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (validateBoolean) dispatch(create_place(place))
    ...
    return (
        <form onSubmit={handleSubmit} className={`form ${style}Form`}>
            ...
            <span className={`${style}Span spanField`}>Los campos con * son obligatorios</span>

            <span className="formSpan">{error}</span>

            <button type="submit" className={`btnSubmit ${style}BtnSubmit`} disabled={!validateBoolean}>Crear</button>
